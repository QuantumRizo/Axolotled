...
import { Beaker, CheckCircle2, ArrowLeft } from 'lucide-react';
import { Link } from 'react-router-dom';

const Resinas: React.FC = () => {
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="text-center mb-16">
                        <h1 className="text-4xl md:text-5xl font-bold text-textMain mb-6">
                            Catálogo de <span className="text-brand-orchid">Resinas</span>
                        </h1>
                        <p className="max-w-3xl mx-auto text-lg text-textMuted">
                            Especificaciones técnicas de nuestros materiales SLA (Estereolitografía).
                        </p>
                    </div>
